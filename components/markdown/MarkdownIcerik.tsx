...
function AnlatimNotu({ children }: { children: ReactNode }) {
  return (
    <div className="not-prose my-4 rounded-r-lg border-l-4 border-brand-orange bg-orange-50 py-3 pl-4 pr-4 text-sm text-orange-900 [&_p]:m-0 [&_p]:leading-relaxed dark:bg-orange-950/40 dark:text-orange-100">
      {children}
    </div>
  );
}
