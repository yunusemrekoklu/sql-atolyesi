  ...
  return (
    <div className="space-y-6">
      {sorular.map((soru, i) => {
        ...
        return (
          <div key={soru.id} className="space-y-2 rounded-xl border border-zinc-200 p-4 dark:border-zinc-800">
            <p className="flex items-center justify-between gap-2 text-xs text-zinc-500 dark:text-zinc-400">
              <span>{soru.konu}</span>
            </p>
