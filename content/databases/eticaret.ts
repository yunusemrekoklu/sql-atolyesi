...
INSERT INTO musteriler (musteri_id, ad_soyad, sehir, kayit_tarihi) VALUES
  (1, 'Caner Şahin', 'İstanbul', '2024-01-15'),
  (2, 'Elif Yıldız', 'Ankara', '2024-02-03'),
  (3, 'Selin Aydın', 'İzmir', '2024-02-20'),
  (4, 'Murat Bakır', 'İstanbul', '2024-03-05'),
  (5, 'Zeynep Arslan', 'Bursa', '2024-03-18'),
  (6, 'Burak Koç', 'Antalya', '2024-04-02'),
  (7, 'Deniz Yavuz', 'İstanbul', '2024-04-22'),
  (8, 'Gizem Polat', 'Ankara', '2024-05-10'),
  (9, 'Emre Şahin', 'İzmir', '2024-05-30'),
  (10, 'Aylin Demirtaş', 'Bursa', '2024-06-14'),
  (11, 'Kerem Uçar', 'İstanbul', '2024-07-01'),
  (12, 'Nazlı Öztürk', 'Antalya', '2024-07-19');
...
INSERT INTO siparisler (siparis_id, musteri_id, siparis_tarihi, durum) VALUES
  (1, 1, '2025-01-05', 'Teslim Edildi'),
  (2, 2, '2025-01-08', 'Teslim Edildi'),
  (3, 1, '2025-01-20', 'Kargoda'),
  (4, 3, '2025-02-02', 'Teslim Edildi'),
  (5, 4, '2025-02-10', 'İptal'),
  (6, 5, '2025-02-14', 'Teslim Edildi'),
  (7, 2, '2025-02-25', 'Hazırlanıyor'),
  (8, 6, '2025-03-01', 'Teslim Edildi'),
  (9, 7, '2025-03-05', 'Kargoda'),
  (10, 1, '2025-03-12', 'Teslim Edildi'),
  (11, 8, '2025-03-20', 'Teslim Edildi'),
  (12, 9, '2025-03-28', 'İptal'),
  (13, 3, '2025-04-02', 'Teslim Edildi'),
  (14, 10, '2025-04-10', 'Hazırlanıyor'),
  (15, 5, '2025-04-15', 'Teslim Edildi');
